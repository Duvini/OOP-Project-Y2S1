  ...
  <body>
    ...
    <div class="popup" id="error">
      <div class="popup-content">
        ...
        <p class="para">Action is unsuccessful</p>
        <form action="">
         <a href="productList.jsp" class="button button-center" id="e_button">OKAY</a>
        </form>         
        </div>
        </div>
       </body> 
       <script>
       var success_popup=document.getElementById("error");
       
       var s_close=document.getElementById("e_button");
     
       var s_btn =document.getElementById("unsuccess_trigger");
